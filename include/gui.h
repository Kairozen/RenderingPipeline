...
class Gui : public GuiInterface
{
    public:
        ...
        unsigned int get_win_width() const { return this->window_width; };
        unsigned int get_win_height() const { return this->window_height; };

        //! Renders a point to the screen.
        //! @param p -- coordinates on the screen.
        //! @param c -- color of the point.
        void render_point( Vec2r p, Color c ) const
        {
        ...
        void render_line( Vec2r a, Vec2r b, Color c ) const
        {
        ...
        void render_text( Vec2r pos, std::string text, Color color ) const
        {
            // Render text surface.
    ...
    private:
        ...
        const char ttf_file[19] = "fonts/VeraMono.ttf";
        ...
        Vec2i screen_coords(Vec2r cc) const
        {
